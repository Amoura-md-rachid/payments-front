...
// Déclaration de la classe AuthorizationGuard.
export class AuthorizationGuard {

  // Le constructeur de la classe est privé, ce qui signifie qu'il ne peut être appelé que depuis l'intérieur de la classe.
  ...
  // La méthode canActivate détermine si une route peut être activée.
